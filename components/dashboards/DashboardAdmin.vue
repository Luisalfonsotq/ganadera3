...
<template>
  <div class="space-y-8 animate-fade-in">
    <!-- Header Welcome -->
    <div class="bg-gradient-to-r from-emerald-800 to-emerald-600 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
      <!-- Decoración de fondo -->
      <div class="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl"></div>
      <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-40 h-40 bg-yellow-400 opacity-20 rounded-full blur-2xl"></div>

      <div class="relative z-10 flex flex-col md:flex-row items-center gap-6">
        <div class="relative group">
          <div class="absolute -inset-0.5 bg-gradient-to-r from-yellow-400 to-green-400 rounded-full opacity-75 group-hover:opacity-100 transition duration-200 blur"></div>
          <img
            :src="userAvatar"
            alt="Avatar"
        ...
        <div class="text-center md:text-left">
          ...
          <div class="flex items-center justify-center md:justify-start gap-3 mt-4">
            ...
            <span class="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium border border-white/30 flex items-center">
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Stat Card 1 -->
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-red-100 hover:shadow-md transition-shadow duration-300 relative overflow-hidden">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div v-if="fincas.length === 0" class="bg-white rounded-xl shadow-sm p-12 text-center border-dashed border-2 border-slate-200">
            ...
            >
              ...
              <div class="p-5">
                <div class="flex justify-between items-start mb-4">
                  ...
                  <span class="text-xs font-semibold text-slate-400 bg-slate-50 px-2 py-1 rounded border border-slate-100">
                    ID: {{ finca.id.toString().padStart(4, '0') }}
                  </span>
                </div>
                
                <h3 class="text-lg font-bold text-slate-800 mb-1 group-hover:text-emerald-700 transition">{{ finca.nombre }}</h3>
           ...
           <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
              ...
              <div class="space-y-4">
                <div class="flex items-center p-3 rounded-lg bg-red-50 border border-red-100 hover:bg-red-100 transition">
                 ...
                 <div class="flex items-center p-3 rounded-lg bg-orange-50 border border-orange-100 hover:bg-orange-100 transition">
                 ...
                 <div class="text-center pt-2">
                   <button class="text-sm text-slate-500 hover:text-emerald-600 font-medium underline">Ver reporte sanitario completo</button>
                 </div>
              </div>
           </div>

           <!-- Selected Finca Quick View -->
           <div v-if="selectedFinca" class="bg-white rounded-xl shadow-sm border border-emerald-100 p-6 animate-fade-in-up">
               ...
               <div class="space-y-4">
                  <div>
                    ...
                    <div class="flex justify-between mt-1 text-sm text-slate-600">
                       <span class="flex items-center"><span class="w-2 h-2 bg-blue-500 rounded-full mr-1"></span> Machos: {{ selectedFinca.stats?.machos }}</span>
                       <span class="flex items-center"><span class="w-2 h-2 bg-pink-500 rounded-full mr-1"></span> Hembras: {{ selectedFinca.stats?.hembras }}</span>
                    </div>
                  </div>
