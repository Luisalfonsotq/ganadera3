...
//     const response = await $fetch<AuthResponse>(`${runtimeConfig.public.apiBaseUrl}/auth/register`,{
//       method: 'POST',
//       body: credentials,
//       credentials: 'include',
//     });
...
//     const response = await $fetch<{ user:{ nombre: string; email: string; rol: string;}}>(`${runtimeConfig.public.apiBaseUrl}/auth/login`, {
//       method: 'POST',
//       body: credentials,
//       credentials: 'include',
//     });
...
//   const logout = async () => {
//     try{
//       await $fetch(`${runtimeConfig.public.apiBaseUrl}/auth/logout`, {
//         method: 'POST',
//         credentials: 'include',
//       });
//       user.value = null;
