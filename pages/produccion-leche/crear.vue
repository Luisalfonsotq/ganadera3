  ...
  <div class="p-6 bg-slate-50 min-h-screen flex justify-center items-start pt-10 animate-fade-in">
    <div class="w-full max-w-3xl space-y-6">
      ...
      <div class="flex items-center justify-between">
        <NuxtLink to="/produccion-leche"
          class="inline-flex items-center text-slate-500 hover:text-emerald-600 transition-colors group">
          <div
            class="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center mr-3 group-hover:border-emerald-500 shadow-sm">
        ...
        <div class="p-8">
          ...
          <form @submit.prevent="submitForm" class="space-y-8">
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <select v-model="form.finca_id" required
                ...
                <div>
                  ...
                  <div class="relative">
                    <select v-model="form.animal_id" required :disabled="!form.finca_id || loadingAnimales"
                    ...
                    <div v-if="loadingAnimales" class="absolute right-10 top-3.5">
                      <div class="animate-spin h-4 w-4 border-2 border-emerald-500 border-t-transparent rounded-full">
                      </div>
                    </div>
                  </div>
                  <p v-if="!loadingAnimales && form.finca_id && animalesFiltrados.length === 0"
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="date" v-model="form.fecha" required :max="todayDate"
              ...
              <div>
                ...
                <div class="relative">
                  <input type="number" step="0.01" min="0" v-model="form.cantidad" required
                  ...
                  <span
                    class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 font-bold bg-slate-200 px-2 py-1 rounded text-xs tracking-wider">LITROS</span>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea v-model="form.observaciones" rows="3"
                  ...
                  placeholder="Escribe comentarios adicionales aquí..."></textarea>
              </div>
            </div>

            <!-- Global Error -->
            <div v-if="error"
              class="p-4 rounded-xl bg-red-50 text-red-700 text-sm border border-red-100 flex items-start">
            ...
            <div class="flex justify-end pt-4 border-t border-slate-100">
              <button type="button" @click="router.push('/produccion-leche')"
...
// Fecha máxima = hoy (para no permitir fechas futuras)
